...
local device_ethernet   = "eno1"
local device_wifi       = "wlp4s0"
...
-- fonts
local theme_font_type                       = "Iosevka"
local theme_font_size                       = "12"
local hotkeys_font_type                     = "Iosevka"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({position = "top", screen = s, height = dpi(30), border_width = dpi(5), border_color = theme.bg_normal .. "0", bg = theme.bg_normal, fg = theme.fg_normal})
